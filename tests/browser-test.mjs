...
async function runTests() {
    ...
    try {
        ...
        await page.screenshot({ path: '/home/juhur/PROJECTS/project_IRB-assist/tests/screenshots/01-after-login.png' });
        ...
        await page.screenshot({ path: '/home/juhur/PROJECTS/project_IRB-assist/tests/screenshots/02-projects-page.png' });
        ...
        await page.screenshot({ path: '/home/juhur/PROJECTS/project_IRB-assist/tests/screenshots/03-project-page.png' });
            ...
            if (tabButton) {
                try {
                    ...
                    if (contentVisible) {
                        ...
                        await page.screenshot({ path: `/home/juhur/PROJECTS/project_IRB-assist/tests/screenshots/04-tab-${tab}.png` });
                    } else {
                        logWarning(`${tab} tab clicked but content visibility unclear`);
                        await page.screenshot({ path: `/home/juhur/PROJECTS/project_IRB-assist/tests/screenshots/04-tab-${tab}-questionable.png` });
                    }
                } catch (e) {
        ...
        // Final screenshot
        await page.screenshot({ path: '/home/juhur/PROJECTS/project_IRB-assist/tests/screenshots/99-final-state.png' });
...
await import('fs').then(fs => {
    const dir = '/home/juhur/PROJECTS/project_IRB-assist/tests/screenshots';
