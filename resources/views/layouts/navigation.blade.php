    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center gap-8">
                <!-- Logo -->
                <a href="{{ route('studies.index') }}" class="flex items-center gap-3" aria-label="IRB Assistant — go to studies">
                    <x-application-logo class="block h-8 w-auto" aria-hidden="true" />
                    <span class="hidden sm:block text-lg font-bold text-slate-900 dark:text-white">IRB Assistant</span>
                </a>
                ...
                <div class="hidden sm:flex items-center gap-1">
                    ...
                    <x-nav-link :href="route('welcome')" :active="request()->routeIs('welcome')">
                        <svg class="w-4 h-4 mr-1.5" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        {{ __('About') }}
                    </x-nav-link>
                </div>
            </div>
