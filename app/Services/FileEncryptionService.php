...
class FileEncryptionService
{
    ...
    public function __construct()
    {
        ...
        // See config/irb.php and SECURITY_CHECKLIST.md (2026-05-10 incident).
        $this->keys = $this->parseKeyring((string) config('irb.file_encryption_keys', ''));

        $active = trim((string) config('irb.file_encryption_active_key_id', ''));
