...
class DocumentExtractionService
{
    ...
    {
        $timeout = (int) config('irb.pdftotext_timeout_seconds', 20);
        $maxPages = (int) config('irb.pdf_max_pages', 200);
        $maxBytes = (int) config('irb.pdf_max_text_bytes', 5_000_000);
        ...
        $memoryLimit = (int) config('irb.pdf_parser_memory_mb', 256);
