...
class AdminTemplateController extends Controller
{
    ...
    {
        // Outstanding #50: wrap the activation in a transaction so two admins
        // concurrently activating two versions of the same template name cannot
        // observe a window where both is_active=true.
        DB::transaction(function () use ($request, $template, $audit): void {
            // Outstanding #49 — multi-form rollout: scope deactivation to the SAME
            // template name so activating HRP-503 does not deactivate HRP-503c or HRP-398.
