...
class ReviewTabViewModel
{
    ...
    public function getFieldListData(Collection $fieldValues): array
    {
        ...
        $preparedFieldValues = $fieldValues->map(function (ProjectFieldValue $fv) {
            ...
            return [
                ...
                // REQ-IRB-GUIDE-019: per-row amber treatment for ai_draft rows regardless of project mode.
                'is_ai_draft' => $fv->isAiDraft(),
            ];
        });
     ...
     *
     * @return array{label: string, key: string, suggested_value: string|null, final_value: string|null, show_suggested: bool, show_final: bool, is_edited: bool, status: string, confidence: string|null, evidence_count: int, is_ai_draft: bool, meta_warnings: array}
     */
    public function getFieldEditorData(): array
    {
        ...
        // REQ-IRB-GUIDE-019 / REQ-IRB-GUIDE-021: surface ai_draft flag and warnings for amber UI treatment.
        $metaWarnings = (array) ($this->selected->meta['warnings'] ?? []);
        ...
        return [
            ...
            // REQ-IRB-GUIDE-019: per-row amber treatment for ai_draft rows regardless of project mode.
            'is_ai_draft' => $this->selected->isAiDraft(),
            // REQ-IRB-GUIDE-021: unverified-specific warning chips.
